...
import com.zosh.model.IssueDTO;
...
public class IssueController {
    ...
    @PostMapping("")
    public ResponseEntity<IssueDTO> createIssue(@Valid @RequestBody IssueRequest issue, @RequestHeader("Authorization") String token) throws Exception {
